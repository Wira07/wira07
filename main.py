...
def main():
    ...
    t.gen_text("Copyright (C) 2023, \x1b[31mWira07 Softwares Inc.\x1b[0m", 2)
    ...
    t.delete_row(7)
    t.gen_text("Memory Test: 1337KB OK", 7, count=10, contin=True)
    ...
    t.toggle_show_cursor(True)
    t.gen_typing_text("Wira07", 3, contin=True)
    ...
    git_user_details = gifos.utils.fetch_github_stats("Wira07", ignore_repos)
    user_age = gifos.utils.calc_age(26, 7, 2002)
    t.clear_frame()
    top_languages = [lang[0] for lang in git_user_details.languages_sorted]
    user_details_lines = f"""
    \x1b[30;101mWira07@GitHub\x1b[0m
    --------------
    \x1b[96mOS:     \x1b[93mKali Linux, Windows 11, Android 13\x1b[0m
    \x1b[96mHost:   \x1b[93mKuningan University \x1b[94m\x1b[0m
    \x1b[96mKernel: \x1b[93mComputer Science \x1b[94m#CS\x1b[0m
    \x1b[96mUptime: \x1b[93m{user_age.years} years, {user_age.months} months, {user_age.days} days\x1b[0m
    \x1b[96mIDE:    \x1b[93mVSCode, Android Studio, Intellij IDEA\x1b[0m

    \x1b[30;101mContact:\x1b[0m
    --------------
    \x1b[96mEmail:      \x1b[93mwiralodrasaputra07@gmail.com\x1b[0m
    \x1b[96mLinkedIn:   \x1b[93mwira-sukma-saputra\x1b[0m
    ...
    t.gen_typing_text(" -u Wira07", 1, contin=True)
    ...
    t.toggle_show_cursor(True)
    # t.pasteImage("./temp/Wira07.jpg", 3, 5, sizeMulti=0.5)
